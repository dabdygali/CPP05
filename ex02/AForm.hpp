...
/*   Updated: 2024/07/15 17:10:16 by dabdygal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#pragma once
	...
	class AForm
	{
		...
		public:
			...
			void	execute(Bureaucrat const & executor) const throw (GradeTooHighException, GradeTooLowException, FormIsNotSigned);
